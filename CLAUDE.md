...
12. **Claude Code hooks have five authorized categories — rule #12.** See `.claude/rules/hooks.md` (HOK-001..010): logging, validation, notification (ADR-0015 D2), tooling-spawn (ADR-0033 D1), context injection (ADR-0057 D4). Hooks may NOT auto-invoke skills or subagents — that hard line is preserved across all five categories. (Mechanized by HOOK-INTEGRITY health row.)
